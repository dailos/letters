...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Edit Letter', true), array('action' => 'edit', $letter['Letter']['id'])); ?> </li>		
		<li><?php echo $this->Html->link(__('Back', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Attach.', true), array('controller' => 'attachments', 'action' => 'upload',$letter['Letter']['id'])); ?> </li>
	</ul>
</div>
<div class="related">
<?php 
if (!empty($letter['Attachment'])){
	foreach ($letter['Attachment'] as $attachment){	
		...
		<div class="attachheader">
			...
			<?php 			
		  	echo $this->Html->link($this->Html->image('download.png'), array('controller' => 'attachments', 'action' => 'download', $attachment['id']), array( 'escape' => false) );
			echo $this->Html->link($this->Html->image('delete.png'), array('controller' => 'attachments', 'action' => 'delete', $attachment['id'], $letter['Letter']['id']), array( 'escape' => false) , sprintf(__('Are you sure you want to delete # %s?', true), $attachment['id'])); 		 	
		 	?>		
		 	</div>
		</div>
		<div class="attach">
